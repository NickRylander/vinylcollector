...
ActiveRecord::Schema.define(version: 2020_11_05_140217) do
  ...
  create_table "songs", force: :cascade do |t|
    t.string "title"
    t.integer "duration"
    t.integer "vinyl_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["vinyl_id"], name: "index_songs_on_vinyl_id"
  end
